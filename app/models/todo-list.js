...
@solid({
  ...
  // type: "http://schema.org/TodoList", // optional, defining NS is good enough if this is derived from the namespace.
...
export default class TodoList extends SemanticModel {
  @string() title;
  @hasMany({ noBlankNodes: true, model: 'todo', rdfList: true }) todos;
}
